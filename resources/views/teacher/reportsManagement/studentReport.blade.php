                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Student Reports</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/teacher/dashboard"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="/teacher/reports/studentReport">Student Report</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Filter and View Student Registrations</h5>
                    </div>
                    <div class="card-body">
                        <!-- Date Selection Form -->
                        <form method="GET" action="{{ url('/teacher/reports/studentReport') }}">
                        ...
                        <!-- Download Button -->
                        <div class="mt-3">
                            <button class="btn btn-primary" onclick="downloadStudentReport()">Download Student Report</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function downloadStudentReport() {
        ...
        doc.setFontSize(18);
        doc.text("Student Report", 105, 20, null, null, 'center');
