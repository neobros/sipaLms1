                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/admin/teachersManagement/newTeachersList">New Teachers List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                                <table class="table table-inverse" id="table_filter" >
                                    ...
                                    <tbody>
                                        @foreach($newTeacherList as $key => $list)
                                        <tr>
                                            <td>{{++$key}}</td>
                                            <td>
                                            ...
                                            <a href="/admin/ApproveTeacher/{{$list->Teacher_ID  }}"><button
                                                        style="width: 35px; height: 35px" type="button"
