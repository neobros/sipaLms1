        ...
        <div class="row pt-5">
            <div class="col-lg-8">
                <div class="d-flex flex-column text-left mb-3">
                    <p class="section-title pr-5"><span class="pr-2">Class Detail Page</span></p>
                    <h1 class="mb-3"> {{$classData->subj_name1}}</h1>
                    <div class="d-flex">
                        <p class="mr-3"><i class="fa fa-user text-primary"></i> {{$classData->subj_stream1}}</p>
                        <p class="mr-3"><i class="fa fa-folder text-primary"></i> {{$classData->subj_name1}}</p>
                        <p class="mr-3"><i class="fa fa-comments text-primary"></i> {{$classData->Class_type}}</p>
                    </div>
                </div>
                <div class="mb-5">
                    <img class="img-fluid rounded w-100 mb-4"  style="max-height: 599px; "src="{{ asset('uploads/' . $classData->Class_image) }}" alt="Image">
                    ...
                    <div class="row">
                        <div class="card border-3 bg-light shadow-sm pb-2">
                            <div class="card-footer bg-transparent py-4 px-5">
                                <div class="row border-bottom">
                                    <div class="col-6 py-1 text-right border-right"><strong>Subject Type</strong></div>
                                    <div class="col-6 py-1">{{$classData->Class_type}}</div>
                                </div>
                                <div class="row border-bottom">
                                    <div class="col-6 py-1 text-right border-right"><strong>Time</strong></div>
                                    <div class="col-6 py-1">{{$classData->Class_date}}</div>
                                </div>
                                <div class="row border-bottom">
                                    <div class="col-6 py-1 text-right border-right"><strong>Class Time</strong></div>
                                    <div class="col-6 py-1">{{$classData->Class_time}}</div>
                                </div>
                                <div class="row">
                                    <div class="col-6 py-1 text-right border-right"><strong>Tution Fee</strong></div>
                                    <div class="col-6 py-1">RS {{$classData->price}} / Month</div>
                                </div>
                            </div>

                            @if(Auth::guard('student')->check())  
                            <a href="/reservation/{{$classData->Class_ID}}" class="btn btn-primary px-4 mx-auto mb-4">Join Now</a>
                            @else
                ...
                <!-- <div class="mb-5 mx-n3">
                    ...
                    <div class="owl-carousel post-carousel position-relative">
                        <div class="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                            <img class="img-fluid" src="/student/img/post-1.jpg" style="width: 80px; height: 80px;">
                            <div class="pl-3">
                        ...
                        <div class="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                            <img class="img-fluid" src="/student/img/post-2.jpg" style="width: 80px; height: 80px;">
                            <div class="pl-3">
                                <h5 class="">Diam amet eos at no eos</h5>
                                <div class="d-flex">
                                    <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                        ...
                        <div class="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                            <img class="img-fluid" src="/student/img/post-3.jpg" style="width: 80px; height: 80px;">
                            <div class="pl-3">
                                <h5 class="">Diam amet eos at no eos</h5>
                                <div class="d-flex">
                                    <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                ...
                <!-- <div class="mb-5">
                    ...
                    <div class="media mb-4">
                        <img src="/student/img/user.jpg" alt="Image" class="img-fluid rounded-circle mr-3 mt-1" style="width: 45px;">
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                ...
                <div class="d-flex flex-column text-center bg-primary rounded mb-5 py-5 px-4">
                    <img src="{{ asset('uploads/' . $classData->Teach_image1) }}" class="img-fluid rounded-circle mx-auto mb-3" style="width: 100px;">
                    <h3 class="text-secondary mb-3">{{$classData->Teach_name1}}</h3>
                ...
                <!-- Single Image -->
                <!-- <div class="mb-5">
                    <img src="/student/img/blog-1.jpg" alt="" class="img-fluid rounded">
                </div> -->
                ...
                <!-- Single Image -->
                <!-- <div class="mb-5">
                    <img src="/student/img/blog-2.jpg" alt="" class="img-fluid rounded">
                </div> -->
                ...
                <!-- Single Image -->
                <!-- <div class="mb-5">
                    <img src="/student/img/blog-3.jpg" alt="" class="img-fluid rounded">
                </div> -->
